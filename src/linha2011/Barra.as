package linha2011 
{
	...
	public class Barra extends MovieClip
	{
		...
		public function Barra()
		{
			...
			btsOutros = new Array(btPop , btLead, btCg125, btCargo, btCg150, btBros, btXre,  btHornet, btCb300, btCrf);
			...
			var btsOutrosSelected:Array = new Array(btPop, btCg125, btCargo, btCg150, btBros, btCrf, btXre, btCb300, btHornet);
		...
		private function btComboClick(e:MouseEvent):void 
		{
			...
			if ( comboOutros.mascara.scaleY == 0 ) {
				trace("abrir")
				TweenMax.to( comboOutros.mascara , 1, { scaleY:0.70 });
