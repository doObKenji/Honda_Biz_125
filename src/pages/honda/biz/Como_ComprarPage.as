package pages.honda.biz
{
	...
	{	
		...
		{
			if (e.currentTarget.name == "clickAqui")
			{
				TweenLite.to(e.currentTarget, .5, {tint:0x43525A});
			}
			else {
				TweenLite.to(e.currentTarget, .5, {tint:0x3E91DA});
			}
		...
		private function chamaURLHandler(e:MouseEvent):void 
		{
			...
			{
				case "clickAqui":
					navigateToURL(new URLRequest("http://honda.com.br/concessionarias/paginas/default.aspx"), "_blank");
				break;
